                        ...
                        <div class="movie col-md-12 mt-4">
                          <tbody>
                              @foreach($posts as $app)
                                  <tr>
                                    <td>                                      	
                                      	<video src="{{$headline->movie_path}}" type="video/mp4" controls></video>
                ...
                @foreach($posts as $post)
                    <div class="post">
                        <div class="row">
                            ...
                            <div class="image col-md-12 text-right mt-4">
                                @if ($post->image_path)
                            ...
                            <div class="movie col-md-12 text-right mt-4">
                              <tbody>
                                @foreach($posts as $app)
                                    <tr>
                                        <td>
                                          <video src="{{$app->movie_path}}" type="video/mp4" controls></video>
                                        </td>
                                    </tr>
                                @endforeach
                              </tbody>
